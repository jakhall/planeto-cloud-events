  ...
  showDialog(type) {
    ...
    if (this.type === 'create') {
      ...
      this.userform = this.fb.group({
        ...
        'start': new FormControl(new Date('Tue Dec 04 2018 00:00:00 GMT+0000 (Greenwich Mean Time)'), Validators.required),
        'end': new FormControl(new Date('Tue Dec 04 2018 00:00:00 GMT+0000 (Greenwich Mean Time)'), Validators.required),
